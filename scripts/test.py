...
TEST_TARGET_FOLDER: list[Path] = [PROJECT_ROOT / dir for dir in ["tests", "scripts", "transformerman"]]
...
def run_vulture(options: Sequence[str]) -> None:
    ...
    ensure_packages_installed(["vulture"])

    run_and_print_on_failure(["vulture"], "Vulture")
